...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            ['image'],
            ['label'],
            'team-now/' + DemoDatasetNames.BEST_ARTWORKS,
            'remote',
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            ['image'],
            ['label'],
            'team-now/' + DemoDatasetNames.BIRD_SPECIES,
            'local',
        ),
        (
            Apps.SEARCH_APP,
            ...
            ['lyrics'],
            [],
            'team-now/' + DemoDatasetNames.POP_LYRICS,
            'local',
        ),
        (
            Apps.SEARCH_APP,
            ...
            ['video', 'description'],
            [],
            'team-now/' + DemoDatasetNames.TUMBLR_GIFS_10K,
            'local',
        ),
    ],
)
