...
def test_start_with_parameters(cleanup, deployment_type, app, dataset):
    ...
    bash_command = (
        f"python {python_file} start --app {app} --index_fields .jpg --dataset_path "
