...
def test_search_update_profanity(tmpdir):
    ...
    da = DocumentArray(
        [
            Document(chunks=[Document(chunks=[Document(text='background')])]),
            Document(chunks=[Document(chunks=[Document(text='background')])]),
            Document(chunks=[Document(chunks=[Document(text='shit')])]),
            Document(chunks=[Document(chunks=[Document(text='loading')])]),
            Document(chunks=[Document(chunks=[Document(text='fuck')])]),
            Document(chunks=[Document(chunks=[Document(text='f*ck')])]),
            Document(chunks=[Document(chunks=[Document(text='laugh')])]),
            Document(chunks=[Document(chunks=[Document(text='fuck shit somethings')])]),
        ]
    )
...
def test_get_suggestion_bitrigrams(tmpdir):
    ...
    da = DocumentArray(
        [
            Document(chunks=[Document(chunks=[Document(text='aziz')])]),
            Document(chunks=[Document(chunks=[Document(text='test')])]),
            Document(chunks=[Document(chunks=[Document(text='aziz test')])]),
            Document(chunks=[Document(chunks=[Document(text='red')])]),
            Document(chunks=[Document(chunks=[Document(text='red dress')])]),
            Document(chunks=[Document(chunks=[Document(text='red long dress')])]),
        ]
    )
