...
def load_data(
    user_input: UserInput, data_class=None, status_callback=print
) -> DocumentArray:
    ...
    :param status_callback: The callback function that should be used to print the status.
    :return: The loaded DocumentArray.
    """
    da = None
    if user_input.dataset_type in [DatasetTypes.DOCARRAY, DatasetTypes.DEMO]:
        status_callback('⬇  Pull DocumentArray dataset')
        ...
        status_callback('🔍  Loading data from Elasticsearch')
