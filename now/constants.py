...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.131-refactor-test-pr'
NOW_PREPROCESSOR_VERSION = '0.0.98-refactor-test-pr'
NOW_QDRANT_INDEXER_VERSION = '0.0.6-refactor-test-pr'
NOW_ELASTIC_INDEXER_VERSION = '0.0.5-refactor-test-pr'
NOW_AUTOCOMPLETE_VERSION = '0.0.3-refactor-test-pr'
