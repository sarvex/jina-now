...
# ----------------------------------
NOW_PREPROCESSOR_VERSION = '0.0.113-enable-local-testing-3'
NOW_QDRANT_INDEXER_VERSION = '0.0.11-enable-local-testing-3'
NOW_ELASTIC_INDEXER_VERSION = '0.0.10-enable-local-testing-3'
NOW_AUTOCOMPLETE_VERSION = '0.0.6-enable-local-testing-3'
