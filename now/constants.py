...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.147-fix-playground-import-2'
NOW_PREPROCESSOR_VERSION = '0.0.121-refactor-remove-ocr-4'
NOW_ELASTIC_INDEXER_VERSION = '0.0.143-refactor-remove-ocr-4'
