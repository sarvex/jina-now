...
NOW_GATEWAY_VERSION = '0.0.3-refactor-faster-gateway-builds-2'
NOW_PREPROCESSOR_VERSION = '0.0.123-test-use-setup-3'
NOW_ELASTIC_INDEXER_VERSION = '0.0.147-test-use-setup-3'
