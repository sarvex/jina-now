...
NOW_GATEWAY_VERSION = '0.0.5-feat-html-to-pdf-4'
NOW_PREPROCESSOR_VERSION = '0.0.124-feat-html-to-pdf-4'
NOW_ELASTIC_INDEXER_VERSION = '0.0.148-refactor-feat-html-to-pdf-4'
NOW_AUTOCOMPLETE_VERSION = '0.0.11-feat-html-to-pdf-4'
