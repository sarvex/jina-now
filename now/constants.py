...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.142-refactor-bump-jina-version-to-latest-3'
NOW_PREPROCESSOR_VERSION = '0.0.119-refactor-bump-jina-version-to-latest-3'
NOW_ELASTIC_INDEXER_VERSION = '0.0.141-refactor-bump-jina-version-to-latest-3'
NOW_AUTOCOMPLETE_VERSION = '0.0.8-feat-refactor-bump-jina-version-to-latest-3'
