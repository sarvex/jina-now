...
NOW_GATEWAY_VERSION = '0.0.5-feat-use-logger-15'
NOW_PREPROCESSOR_VERSION = '0.0.125-feat-use-logger-16'
NOW_ELASTIC_INDEXER_VERSION = '0.0.149-feat-use-logger-16'
NOW_AUTOCOMPLETE_VERSION = '0.0.12-feat-use-logger-16'
