...
NOW_GATEWAY_VERSION = '0.0.6-fix-m2m-token-9'
NOW_PREPROCESSOR_VERSION = '0.0.125-fix-m2m-token-9'
NOW_ELASTIC_INDEXER_VERSION = '0.0.149-fix-m2m-token-9'
NOW_AUTOCOMPLETE_VERSION = '0.0.12-fix-m2m-token-9'
