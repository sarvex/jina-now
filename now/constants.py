...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.144-fix-bucket-uri-json-field-18pytest --suppress-no-test-exit-code -v -s tests/executor/preprocessor'
NOW_PREPROCESSOR_VERSION = '0.0.120-fix-bucket-uri-json-field-18pytest --suppress-no-test-exit-code -v -s tests/executor/preprocessor'
NOW_ELASTIC_INDEXER_VERSION = '0.0.142-fix-bucket-uri-json-field-18pytest --suppress-no-test-exit-code -v -s tests/executor/preprocessor'
