...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.127-elastic-indexer-33'
NOW_PREPROCESSOR_VERSION = '0.0.88-elastic-indexer-33'
NOW_AUTH_EXECUTOR_VERSION = '0.0.5-auth-exec-4'
NOW_ANNLITE_INDEXER_VERSION = '0.0.6-annlite-update-list-endpoint-4'
NOW_ELASTIC_INDEXER_VERSION = '0.0.1-feat-elastic-55'
