...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.144-refactor-user-input-in-args-4'
NOW_PREPROCESSOR_VERSION = '0.0.120-refactor-user-input-in-args-4'
NOW_ELASTIC_INDEXER_VERSION = '0.0.142-refactor-user-input-in-args-4'
NOW_AUTOCOMPLETE_VERSION = '0.0.9-refactor-user-input-in-args-4'
