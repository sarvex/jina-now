...
NOW_PREPROCESSOR_VERSION = '0.0.97-fix-executor-inheritance-issues-1'
DOCKER_BFF_PLAYGROUND_TAG = '0.0.130-test-multimodal-20'
NOW_QDRANT_INDEXER_VERSION = '0.0.4-fix-executor-inheritance-issues-1'
NOW_ELASTIC_INDEXER_VERSION = '0.0.4-fix-executor-inheritance-issues-1'
NOW_AUTOCOMPLETE_VERSION = '0.0.2-fix-executor-inheritance-issues-1'
