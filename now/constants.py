...
# ----------------------------------
NOW_PREPROCESSOR_VERSION = '0.0.109-refactor-remove-redundancy-on-ci-15'
NOW_QDRANT_INDEXER_VERSION = '0.0.10-refactor-remove-redundancy-on-ci-15'
NOW_ELASTIC_INDEXER_VERSION = '0.0.9-refactor-remove-redundancy-on-ci-15'
NOW_AUTOCOMPLETE_VERSION = '0.0.5-refactor-remove-redundancy-on-ci-15'
