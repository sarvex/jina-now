...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.124-adapt-playground-2'
NOW_PREPROCESSOR_VERSION = '0.0.86-finetune-1'
NOW_AUTH_EXECUTOR_VERSION = '0.0.5-auth-exec-4'
NOW_ANNLITE_INDEXER_VERSION = '0.0.4-annlite-adapt-playground-5'
