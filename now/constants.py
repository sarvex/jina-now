...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.140-refactor-bump-jina-version7'
# ----------------------------------
NOW_PREPROCESSOR_VERSION = '0.0.117-refactor-bump-jina-version7'
NOW_QDRANT_INDEXER_VERSION = '0.0.138-refactor-bump-jina-version7'
NOW_ELASTIC_INDEXER_VERSION = '0.0.139-refactor-bump-jina-version7'
NOW_AUTOCOMPLETE_VERSION = '0.0.7-refactor-bump-jina-version7'
