...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.123-filtering-playground-2'
NOW_PREPROCESSOR_VERSION = '0.0.83-filtering-playground-2'
NOW_AUTH_EXECUTOR_VERSION = '0.0.5-auth-exec-4'
NOW_ANNLITE_INDEXER_VERSION = '0.0.3-annlite-add-tags'
