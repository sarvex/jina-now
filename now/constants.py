...
NOW_GATEWAY_VERSION = '0.0.6-fix-test-timeout-21'
NOW_PREPROCESSOR_VERSION = '0.0.125-fix-test-timeout-21'
NOW_ELASTIC_INDEXER_VERSION = '0.0.149-fix-test-timeout-21'
NOW_AUTOCOMPLETE_VERSION = '0.0.12-fix-test-timeout-21'
