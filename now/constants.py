...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.125-playground-requirement-6'
NOW_PREPROCESSOR_VERSION = '0.0.85-fix-dup-code-5'
NOW_AUTH_EXECUTOR_VERSION = '0.0.5-auth-exec-4'
NOW_ANNLITE_INDEXER_VERSION = '0.0.4-annlite-playground-requirement-comment-fix-1'
