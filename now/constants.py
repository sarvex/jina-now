...
DOCKER_BFF_PLAYGROUND_TAG = '0.0.123-adapt-playground-10'
NOW_PREPROCESSOR_VERSION = '0.0.83-finetuning6'
NOW_AUTH_EXECUTOR_VERSION = '0.0.5-auth-exec-4'
NOW_ANNLITE_INDEXER_VERSION = '0.0.3-annlite-adapt-playground-7'
