...
# ----------------------------------
DOCKER_BFF_PLAYGROUND_TAG = '0.0.136-fix-telemetry'
NOW_PREPROCESSOR_VERSION = '0.0.112-fix-telemetry'
NOW_QDRANT_INDEXER_VERSION = '0.0.10-fix-telemetry'
NOW_ELASTIC_INDEXER_VERSION = '0.0.9-fix-telemetry'
NOW_AUTOCOMPLETE_VERSION = '0.0.5-fix-telemetry'
